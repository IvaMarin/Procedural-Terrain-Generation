...
public class CanVaultRing : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ////HelperFunctions.GetPlayer(ref player);
    ...
    {
        float angle = HelperFunctions.Get_slope_angle(normal);
    ...
    void Update()
    {
        ...
        {
            Debug.Log(HelperFunctions.Get_slope_angle(hit.normal), hit.collider.gameObject);
